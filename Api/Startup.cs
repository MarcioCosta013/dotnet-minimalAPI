    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddDbContext<DbContexto>(options =>
        {
            options.UseMySql(
                ...
                ServerVersion.AutoDetect(Configuration.GetConnectionString("mysql")) //Na injecao de dependencia já faz essa string ser passar e caso no overrider tbm se estiver vazio
            );
        });
    }
